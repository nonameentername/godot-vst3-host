...
EditorAudioMeterNotchesVst3::EditorAudioMeterNotchesVst3() {
...
float EditorAudioMeterNotchesVst3::_scaled_db_to_normalized_volume(float db) {
...
void EditorAudioMeterNotchesVst3::add_notch(float p_normalized_offset, float p_db_value, bool p_render_value) {
    notches.push_back(AudioNotch(p_normalized_offset, p_db_value, p_render_value));
}

Vector2 EditorAudioMeterNotchesVst3::_get_minimum_size() const {
    ...
    for (const EditorAudioMeterNotchesVst3::AudioNotch &notch : notches) {
...
void EditorAudioMeterNotchesVst3::_update_theme_item_cache() {
...
void EditorAudioMeterNotchesVst3::set_editor_scale(float p_editor_scale) {
    editor_scale = p_editor_scale;
}

float EditorAudioMeterNotchesVst3::get_editor_scale() {
    return editor_scale;
}

void EditorAudioMeterNotchesVst3::_notification(int p_what) {
    switch (p_what) {
...
void EditorAudioMeterNotchesVst3::_draw_audio_notches() {
    float font_height = theme_cache.font->get_height(theme_cache.font_size);

    for (const EditorAudioMeterNotchesVst3::AudioNotch &n : notches) {
...
void EditorAudioMeterNotchesVst3::_bind_methods() {
    ClassDB::bind_method(D_METHOD("add_notch"), &EditorAudioMeterNotchesVst3::add_notch);
    ClassDB::bind_method(D_METHOD("_draw_audio_notches"), &EditorAudioMeterNotchesVst3::_draw_audio_notches);

    ClassDB::bind_method(D_METHOD("get_editor_scale"), &EditorAudioMeterNotchesVst3::get_editor_scale);
    ClassDB::bind_method(D_METHOD("set_editor_scale", "editor_scale"), &EditorAudioMeterNotchesVst3::set_editor_scale);

    ClassDB::add_property("EditorAudioMeterNotchesVst3", PropertyInfo(Variant::FLOAT, "editor_scale"),
