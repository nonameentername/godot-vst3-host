#ifndef EDITOR_AUDIO_METER_NOTCHES_VST3_H
#define EDITOR_AUDIO_METER_NOTCHES_VST3_H
...
class EditorAudioMeterNotchesVst3 : public Control {
    GDCLASS(EditorAudioMeterNotchesVst3, Control);
...
private:
    struct AudioNotch {
        ...
        _FORCE_INLINE_ void operator=(const EditorAudioMeterNotchesVst3::AudioNotch &n) {
            relative_position = n.relative_position;
            db_value = n.db_value;
            render_db_value = n.render_db_value;
        }
...
public:
    EditorAudioMeterNotchesVst3();
};

} // namespace godot

#endif // EDITOR_AUDIO_METER_NOTCHES_VST3_H
